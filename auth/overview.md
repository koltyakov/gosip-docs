...
| :--- | :--- | :--- | :--- |
| Azure AD Auth | ✅ | ❌ | [device](custom-auth/azure-device-flow.md#auth-configuration-and-usage), [certificate](custom-auth/azure-certificate-auth.md), [creds](custom-auth/azure-creds-auth.md) |
